...
export const fightCards: FightCard[] = [
  // ── ONE SAMURAI 1（2026-04-29 有明アリーナ）────────────────
  {
    ...
    fights: [
      ...
      {
        redCorner: { name: "吉成名高", country: "🇯🇵" },
        blueCorner: { name: "ソンチャイノイ・キアットソングリット", country: "🇹🇭" },
        weightClass: "アトム級（-52.2kg）",
        rule: "ムエタイ",
        rounds: "3分5R",
        isTitleMatch: true,
      ...
      },
      {
        ...
        blueCorner: { name: "与座優貴", country: "🇯🇵" },
        weightClass: "バンタム級（-65.8kg）",
        rule: "キックボクシング",
        rounds: "3分5R",
        isTitleMatch: true,
      ...
      {
        redCorner: { name: "マラット・グレゴリアン", country: "🇦🇲" },
        blueCorner: { name: "海人", country: "🇯🇵" },
        weightClass: "フェザー級（-70.3kg）",
        rule: "キックボクシング",
        rounds: "3分3R",
      },
      {
        redCorner: { name: "三浦彩佳", country: "🇯🇵" },
        blueCorner: { name: "澤田千優", country: "🇯🇵" },
        weightClass: "女子アトム級（-47.7kg）",
        rule: "MMA",
        rounds: "5分3R",
      },
      {
        redCorner: { name: "秋元皓貴", country: "🇯🇵" },
        blueCorner: { name: "久井大夢", country: "🇯🇵" },
        weightClass: "バンタム級（-65.8kg）",
        rule: "キックボクシング",
        rounds: "3分3R",
      },
      {
        redCorner: { name: "和島大海", country: "🇯🇵" },
        blueCorner: { name: "リカルド・ブラボ", country: "🇦🇷" },
        weightClass: "フェザー級（-70.3kg）",
        rule: "キックボクシング",
        rounds: "3分3R",
      },
      {
        redCorner: { name: "平田樹", country: "🇯🇵" },
        blueCorner: { name: "リトゥ・フォガット", country: "🇮🇳" },
        weightClass: "女子アトム級（-47.7kg）",
        rule: "MMA",
        rounds: "5分3R",
      },
      {
        redCorner: { name: "和田竜光", country: "🇯🇵" },
        blueCorner: { name: "伊藤盛一郎", country: "🇯🇵" },
        weightClass: "フライ級（-61.2kg）",
        rule: "MMA",
        rounds: "5分3R",
      },
      {
        redCorner: { name: "山北渓人", country: "🇯🇵" },
        blueCorner: { name: "黒澤亮平", country: "🇯🇵" },
        weightClass: "ストロー級（-52.3kg）",
        rule: "MMA",
        rounds: "5分3R",
      },
      {
        redCorner: { name: "吉成士門", country: "🇯🇵" },
        blueCorner: { name: "ジョハン・ガザリ", country: "🇲🇾" },
        weightClass: "フライ級（-61.2kg）",
        rule: "ムエタイ",
        rounds: "3分3R",
      },
      {
        redCorner: { name: "黒田斗真", country: "🇯🇵" },
        blueCorner: { name: "田丸辰", country: "🇯🇵" },
        weightClass: "アトム級（-52.2kg）",
        rule: "キックボクシング",
        rounds: "3分3R",
      },
      {
        redCorner: { name: "陽勇", country: "🇯🇵" },
        blueCorner: { name: "内藤大樹", country: "🇯🇵" },
        weightClass: "フライ級（-61.2kg）",
        rule: "キックボクシング",
        rounds: "3分3R",
      },
      {
        redCorner: { name: "永井奏多", country: "🇯🇵" },
        blueCorner: { name: "神部篤哉", country: "🇯🇵" },
        weightClass: "バンタム級（-65.8kg）",
        rule: "MMA",
        rounds: "5分3R",
      },
